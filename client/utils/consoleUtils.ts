...
/**
 * Returns an array of [lineOffset, filename] for all scripts in the HTML file.
 * @param htmlFile The HTML file as a string
 * @returns Array of [lineOffset, filename]
 */
export function getAllScriptOffsets(htmlFile: string): Array<[number, string]> {
  const offs: Array<[number, string]> = [];
